...
When I was working on [swcli](), I needed to create a URL dynamically, based on user input. I ended up finding 5 approaches to create the URL. Now, I am going to share those 5 approaches, and share which ones may be the best, going forward.
